...
class CartController
{
    ...
    /**
     * Action для добавления количество товара при загрузке
     * 
     */

    public function actionAddAjaxCount()
    {
    ...
    public function actionCheckout()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($errors == false) {
                ...
                $result = Order::save($userName, $userSurname, $userPatronymic, $userPhone, $userDelivery, $userComment, $userId, $productsInCart);
