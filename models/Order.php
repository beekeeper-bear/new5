...
class Order
{
     ...
     */
    public static function save($userName, $userSurname, $userPatronymic, $userPhone, $userDelivery, $userComment, $userId, $products)
    {
        // Соединение с БД
        $db = Db::getConnection();

        // Текст запроса к БД
        $sql = 'INSERT INTO product_order (user_name,  user_surname, user_patronymic, user_phone, user_delivery, user_comment, user_id, products) '
                . 'VALUES (:user_name, :user_surname,:user_patronymic, :user_phone, :user_delivery, :user_comment, :user_id, :products)';
        ...
        $sql1 = 'INSERT INTO product_order (`user_name`,  user_surname, user_patronymic, user_phone, user_delivery, user_comment, `user_id`, products) '
        . " VALUES ($userName, $userSurname, $userPatronymic, $userPhone, $userDelivery, $userComment, $userId, $products)";
